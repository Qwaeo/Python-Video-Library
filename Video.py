...
class Master:
    ...
    def Master_Entry(self):
        ...
        while ch=='Y':
            while True:
                self.Cast_Code = int(raw_input("Cassette/CD Code (1/2/3...) # "))
                ...
                ch = raw_input("Add new Cassette/CD code? <Y/N>: ")
                ch = ch.upper()
                if ch=='Y':
                    continue
                else:
                ...
                if (Flag == True):
                    ...
                    if ch == 'Y':
                        ...
                        with open (File1,'ab+') as Cobj:
                            ...
                            print("Record saved")                
                    ch = raw_input("Stock more cassette/CD record? <Y/N>: ")
                    ch = ch.upper()
                    if ch=='N':
                        break
                    else:
        ...
        while ch=='Y':
            ...
            while True:
                ...
                if (Flag == True):
                    ...
                    self.C_Address = raw_input("Customer address: ")
                    self.C_MPhone = int(raw_input("Customer mobile no.: "))
                    while True:
                        self.No_Of_Cast = int(raw_input("Enter sales cassettes/CDs nos.: "))
